package com.lipeilong.jigsaw.gles;
/*
...
public class GlUtil {
    ...
    public static int createProgram(String vertexSource, String fragmentSource) {
        ...
        if (vertexShader == 0) {
            Toast.makeText(Env.getContext(), "vertexShader ==0 ", Toast.LENGTH_LONG).show();
            return 0;
        }
        int pixelShader = loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentSource);
        if (pixelShader == 0) {
            Toast.makeText(Env.getContext(), "pixelshader ==0 ", Toast.LENGTH_LONG).show();
        ...
        if (program == 0) {
            Toast.makeText(Env.getContext(), "create program ==0 ", Toast.LENGTH_LONG).show();
        ...
        if (linkStatus[0] != GLES20.GL_TRUE) {
            ...
            Toast.makeText(Env.getContext(), "link status ==0 ", Toast.LENGTH_LONG).show();
