...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        // 手动处理异常
        if ((ex != null) && (CrashHandlerConfig.CRASH_LOG == true)) {
            ...
            try {
                ...
                JDLog.log(TAG, "Error : " + e.toString());
            }
    ...
    private String saveCrashInfoToFile(Throwable ex) {
        ...
        String result = "\nstack:\n" + info.toString();
        JDLog.logError(TAG, result);

        printWriter.close();
        //mDeviceCrashInfo.put(STACK_TRACE, result);
        try {

            String path = CrashHandlerConfig.getCrashLogDir();
            ...
            JDLog.log(TAG, "an error occured while writing report file..." + e.toString());
        }
        return null;
    }
    ...
    public void collectCrashDeviceInfo(Context ctx) {
        try {
            ...
            JDLog.log(TAG, "Error while collect package info" + e.toString());
        }
        ...
        for (Field field : fields) {
            try {
                ...
                JDLog.log(TAG, field.getName() + " : " + field.get(null));
            } catch (Exception e) {
                JDLog.log(TAG, "Error while collect crash info" + e);
            }
        }
    }
    ...
    public void collectionDumpHprofDataIfOOM(Throwable ex) {
        ...
        if (isOOM(ex)) {
            try {
                ...
                JDLog.log(TAG, "couldn’t dump hprof,  an error occurs while opening or writing files.");
            } catch (UnsupportedOperationException e) {
                JDLog.log(TAG, "couldn’t dump hprof,  the VM was built without HPROF support.");
            }
        }
    }
